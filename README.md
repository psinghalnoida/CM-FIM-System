...
breakdown added to the operational dashboard), and the Document
...
- [`docs/CLAIM_SUBRECORDS.md`](docs/CLAIM_SUBRECORDS.md) — Survey/Repair/Settlement/Payment as standalone tabbed pages, the new `RepairPart` model, and document-linking extended to claim sub-records.
